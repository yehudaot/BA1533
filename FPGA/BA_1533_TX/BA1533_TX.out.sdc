...
set_input_delay -clock { tx_pll_c|altpll_component|auto_generated|pll1|clk[0] } 0 [get_ports {UART_RXD}]

#**************************************************************
# Set Output Delay
#**************************************************************

set_output_delay -clock { tx_pll_c|altpll_component|auto_generated|pll1|clk[1] } 0 [get_ports {tx_bit_data}]
set_output_delay -clock { tx_pll_c|altpll_component|auto_generated|pll1|clk[0] } 0 [get_ports {UART_TXD}]
